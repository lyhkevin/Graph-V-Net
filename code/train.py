...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--weight_save_path', type=str, default='../weight/finetune_1/')
        self.parser.add_argument('--log_path', type=str, default='./log/finetune_new.log')
        self.parser.add_argument('--vit_path', type=str, default='../weight/HIPT.pth')
        self.parser.add_argument("--weight_save_interval", default=5)
        self.parser.add_argument("--augment", default=True)
        self.parser.add_argument("--oversample", default=[1,3,5,2], help='oversample the patches for each class')
...
if __name__ == '__main__':
    ...
    optimizer_p = torch.optim.Adam(patch_encoder.parameters(), lr=opt.lr_p) # for patch encoder
    ...
    for epoch in range(0, opt.epoch):
        for i, (img, x, label) in enumerate(data_loader):
            ...
            loss = 0.1 * loss_1 + 0.1 * loss_2 + 0.1 * loss_4 + 0.7 * loss_8
